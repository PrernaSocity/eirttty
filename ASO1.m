function [X_Best,Fit_XBest,Functon_Best]=ASO1(alpha,beta,Fun_Index,Atom_Num,Max_Iteration)
...
% beta: Multiplier weight
 ...
 % Iteration
  for Iteration=2:Max_Iteration 
      ...
      % Calculate acceleration.
       Atom_Acc=Acceleration1(Atom_Pop,Fitness,Iteration,Max_Iteration,Dim,Atom_Num,X_Best,alpha,beta);
 end
