...
%% Normal
nbus =30;                  % IEEE-30..
busd = busdat30;      % Calling busdatas..
...
set(gca,'FontWeight','Bold')
plot(ET,Vde2,'-.r*','LineWidth',1.5,'Markersize',7)
xlabel('Bus No')
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
...
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
plot(ET,F2,'-.r*','LineWidth',1.5,'Markersize',7)
xlabel('Bus No')
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
...
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
plot(ET,Vde3,'-.r*','LineWidth',1.5,'Markersize',7)
xlabel('Bus No')
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
legend('With ASA','Without ASA')
...
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
plot(ET,F5,'-.r*','LineWidth',1.5,'Markersize',7)
xlabel('Bus No')
ylabel('Voltage Deviation')
set(gca,'FontWeight','Bold')
legend('With ASA','Without ASA')
...
Lp1=1:41
for i=1:length(Lp1)
    LO(i)=abs(linedat30(i,3)-linedat30(i,4))/i
    if LO(i)<0.1
        LO(i)=(LO(i)+0.1)*500;
    else
        LO(i)=LO(i)*1000;
...
for i=1:length(Lp1)
    GO(i)=abs(linedat30(i,3)-linedat30(i,4))/i
    if GO(i)<0.1
        GO(i)=(GO(i)+0.1)*2000;
    else
        GO(i)=GO(i)*2000;
...
for i=1:length(Lp1)
    BO(i)=abs(linedat30(i,3)-linedat30(i,4))/i
    if BO(i)<0.1
        BO(i)=(BO(i)+0.1)*1230;
    else
        BO(i)=BO(i)*1230;
