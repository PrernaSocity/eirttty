...
hold on;
grid on
plot(Lp2,S2,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Line No')
ylabel('severity index')
set(gca,'FontWeight','Bold')
plot(Lp2,S,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Line No')
ylabel('severity index')
set(gca,'FontWeight','Bold')

legend('Without JAYA','With JAYA')
%% LOSI Equation
Max_MVA = 100;
% JD=Voltagedata(:,7)
JD=[linedat118(:,4)]
...
hold on;
grid on
plot(Lp2(1:186),K2(1:186),'-o','LineWidth',1.5,'Markersize',7)
xlabel('Line No')
ylabel('LOSI ')
set(gca,'FontWeight','Bold')

plot(Lp2(1:186),K_10(1:186),'-o','LineWidth',1.5,'Markersize',7)
xlabel('Line No')
ylabel('LOSI ')
set(gca,'FontWeight','Bold')
...
plot(B(1:100),K_21(1:100),'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')

plot(B(1:100),K_5,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
axis([500 2000 0 1.2])
...
hold on;
grid on
plot(B(1:100),S1,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
axis([500 2000 0 5])
...
plot(B(1:100),K_22,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
axis([600 2000 0 5])
...
plot(B(1:100),K_90,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
% axis([200 1000 0 2])
...
% K_22=sort(K_22,'descend')
K_2=sort(K_2,'descend')
plot(B(1:100),K_2(1:100),'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
% axis([1 2000 0 4]);
...
hold on;
grid on
plot(B1(1:100),K_21(1:100),'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
% axis([1 2000 0 6])
plot(B1(1:100),K_31,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
axis([400 2000 0 1.5])
...
hold on;
grid on
plot(B1(1:100),K_2(1:100),'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
plot(B1(1:100),K_22,'-o','LineWidth',1.5,'Markersize',7)
xlabel('Generation Fuel Cost($/hr)')
ylabel('Severity Function Value')
set(gca,'FontWeight','Bold')
axis([600 2000 0 6])
